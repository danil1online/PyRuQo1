...
# НОВЫЕ ИМПОРТЫ ДЛЯ MARKER 1.X.X
...
SERVERS_POOL = [
    ...
    "http://192.168.2.3:8181/v1/chat/completions"
]
...
# Инициализация моделей Marker по новому стандарту (выполняется 1 раз при старте)
...
def parse_pdf_to_math_markdown(file_path):
 ...
 try:
     # Нейросетевое извлечение текста и формул по новой схеме
