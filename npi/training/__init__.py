def __getattr__(name):
    if name == "NPITrainer":
        from npi.training.trainer import NPITrainer
        return NPITrainer
    elif name == "format_single_example":
        from npi.training.formatting import format_single_example
        return format_single_example
    elif name == "formatting_prompts_func":
        from npi.training.formatting import formatting_prompts_func
