...
from pyruqo1.utils.swap import managed_swap, get_free_ram_gb
...
class LORAMerger:
    ...
    def merge(
        ...
        lora_adapter_dir = lora_dir = lora_adapter_dir or self.config.get("training", {}).get("output_dir", "./output")
